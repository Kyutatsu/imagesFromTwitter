"""
Django settings for twitterImages project.
...
SECRET_KEY = os.environ.get('SECRET_KEY_TW')
...
ROOT_URLCONF = 'twitterImages.urls'
...
WSGI_APPLICATION = 'twitterImages.wsgi.application'
...
STATIC_ROOT = os.environ.get('STATIC_ROOT_TW')
LOGIN_REDIRECT_URL = '/getImagesFromTwitter/'
